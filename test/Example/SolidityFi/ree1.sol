...
contract CareerOnToken {
  ...
  function claimReward_re_ent25() public {
    ...
    msg.sender.call.value(transferValue_re_ent25)("");
    redeemableEther_re_ent25[msg.sender] = 0;
  }
  uint256 public totalSupply;
  mapping(address => uint) userBalance_re_ent19;
  function withdrawBalance_re_ent19() public {
    if (!(msg.sender.call(userBalance_re_ent19[msg.sender])(""))) {
      revert();
    }
  ...
  function buyTicket_re_ent23() public {
    if (!(lastPlayer_re_ent23.call.value(jackpot_re_ent23)(""))) revert();
  ...
  function buyTicket_re_ent30() public {
    if (!(lastPlayer_re_ent30.call.value(jackpot_re_ent30)(""))) revert();
